...
void main()
{
    ...
    Material material;
    material.ambient = texture(DiffuseMap, texCoord);
    material.diffuse = texture(DiffuseMap, texCoord);
    material.specular = texture(DiffuseMap, texCoord);
    ...
    colorADS =
        ...
        specular(eye, newP.xyz, light, textureNormal.xyz, material, 8.0f);
    fragcolor = textureDiffuse+colorADS;
}